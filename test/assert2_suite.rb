...
class Assert21Suite < Test::Unit::TestCase
  ...
  def setup
    colorize(false)
    @effect = Assert2::RubyReflector.new()
    array = [1, 3]
    hash = { :x => 42, 43 => 44 }
    x = 42
...
if Assert2::RubyReflector::HAS_RIPPER
#!doc!
=begin
...
#  TODO  put a nav bar up the side already!
  ...
  def test_extra_assertion_diagnostics_with_ripper
    ...
    expect = if Assert2::RubyReflector::HAS_RIPPER
...
#  note that, in 1.8.7 mode, we at least reflect our diagnostics!
  ...
  def test_assert_with_linefeeds
    x = 42
    return unless Assert2::RubyReflector::HAS_RUBYNODE
  ...
  def test_flunk_2_0
# FIXME    return unless Assert2::RubyReflector::HAS_RUBYNODE
    x = 43
...
if Assert2::RubyReflector::HAS_RUBYNODE #  TODO
